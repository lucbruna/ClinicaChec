...
class ServerScopeListEntity
{
    ...
    public function lookupDescriptionForFullScopeString($scope)
    {
        $requiredSmart = [
            ...
            "api:oemr" => xl("Permission to use the ClinicaChec standard api."),
            "api:fhir" => xl("Permission to use the ClinicaChec FHIR api"),
            "api:port" => xl("Permission to use the ClinicaChec apis from inside the patient portal"),
        ];
