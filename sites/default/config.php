...
const CLINICACHEC_PRINT_COMMAND = 'lpr -P HPLaserjet6P -o cpi=10 -o lpi=6 -o page-left=72 -o page-top=72';

// Enscript command used by HylaFAX (fax_dispatch.php).
const CLINICACHEC_HYLAFAX_ENSCRIPT = 'enscript -M Letter -B -e^ --margins=36:36:36:36';
