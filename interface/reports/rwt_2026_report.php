...
<?php if (empty($_POST['start_button'])) { ?>
    <div class='mt-2 alert alert-primary' role='alert'>
        <?php echo xlt("This report is required for ClinicaChec instances in the United States that utilize ONC certification. This reports collects metrics that are used in Real World Testing that are required for the ClinicaChec Foundation to maintain the ONC certification. This report calculates metrics from April 1, 2026 to September 30, 2026. Please run this report sometime in October or November of 2026 and then print it to a pdf and email the pdf to the ClinicaChec Foundation at hello@clinicachec.com. In the email, please confirm your practice is in the United States and state the clinical setting of your practice (this can be 'Primary/Specialty Care' setting, 'Behavioral Health Care' setting, or any other setting).") ?>
    </div>
...
<?php } else { ?>
    <div id='no_print_area' >
        <div class='mt-2 alert alert-primary' role='alert'>
            <?php echo xlt("Please print this report to a pdf and email the pdf to the ClinicaChec Foundation at hello@clinicachec.com. In the email, please confirm your practice is in the United States and state the clinical setting of your practice (this can be 'Primary/Specialty Care' setting, 'Behavioral Health Care' setting, or any other setting).") ?>
        </div>
        <div class='mt-4'>
