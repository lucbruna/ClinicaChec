...
if ($form_step == 1) {
    $form_status .= xl('Dumping ClinicaChec database') . "...||br-placeholder||";
...
if ($form_step == 3) {
    $form_status .= xl('Dumping ClinicaChec web directory tree') . "...||br-placeholder||";
    echo brCustomPlaceholder(text($form_status));
    $cur_dir = getcwd();
    ...
    if (!create_tar_archive($arch_file, "gz", $file_list)) {
        die(xlt("An error occurred while dumping ClinicaChec web directory tree"));
    }
