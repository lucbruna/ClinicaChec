...
<head>
    ...
    <script>
        ...
        function initSearch() {
            initSelect();
            <?php if ($do_warning) { ?>
            let msg = xl("ClinicaChec is not responsible for any copyright and or permissions pertaining to questionnaires or assessments imported from external sources and then implemented and used by this feature.");
