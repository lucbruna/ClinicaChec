...
<head>
    ...
    <title><?php echo xlt('ClinicaChec App Registration'); ?></title>
    <style>
        .hidden {
            display: none;
        }
            ...
            <?php if ($extraLogo) { ?>
                <div class="text-center">
                    <span class="d-inline-block w-40">
                        <?php echo file_get_contents(OEGlobalsBag::getInstance()->getKernel()->getImagesAbsolute() . "/login-logo.svg"); ?>
                    </span>
        ...
        <div class="<?php echo $formarea; ?>">
            ...
            <div>
                ...
                <div class="form-group errorResponse hidden">
                    ...
                    <p><a target="_blank" href="https://community.open-emr.org/"><?php echo xlt("More support can be found on the ClinicaChec community form"); ?></a></p>
