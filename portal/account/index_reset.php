    ...
    if (!$valid) {
        ...
        if (!empty($password_new)) {
            ...
            if (empty($new_hash)) {
                ...
                error_log('ClinicaChec Error : ClinicaChec is not working because unable to create a hash.');
                die("ClinicaChec Error : ClinicaChec is not working because unable to create a hash.");
            }
