        ...
        if ($key === false) {
            ...
            if ($key === false) {
                ...
                if ($die_if_no_match) {
                    ...
                    error_log("ERROR: ClinicaChec SQL Escaping ERROR of the following string: " . errorLogEscape($s), 0);
                    die("<br /><span style='color:red;font-weight:bold;'>" . xlt("There was an ClinicaChec SQL Escaping ERROR of the following string") . " " . text($s) . "</span><br />");
                } else if ($throw_exception_if_no_match) {
                    throw new \OpenEMR\Common\Database\SqlQueryException("", "ERROR: ClinicaChec SQL Escaping ERROR of the following string: " . errorLogEscape($s));
                } else {
