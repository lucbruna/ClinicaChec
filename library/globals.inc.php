...
$GLOBALS_METADATA = [
    ...
    'Login Page' => [
        ...
        'login_tagline_text' => [
            ...
            'text',
            xl("ClinicaChec — Sistema moderno de gestão em saúde."),
    ...
    'Security' => [
        ...
        'gbl_ldap_dn' => [
            ...
            'text',
            '',
            xl('Embed {login} where the ClinicaChec login name of the user is to be; for example: uid={login},dc=example,dc=com')
        ],
        'gbl_ldap_exclusions' => [
    ...
    'Connectors' => [
        ...
        GlobalConnectorsEnum::SITE_ADDRESS_OAUTH->value => [
            ...
            'text',
            '',
            xl('The hostname for OAuth2, FHIR, CCDA, and Payment Processing, pointing back back to this ClinicaChec instance. e.g. https://localhost:9300.')
        ],

        GlobalConnectorsEnum::REST_FHIR_API->value => [
            xl('Enable ClinicaChec Standard FHIR REST API'),
            'bool',
            '0',
            xl('Enable ClinicaChec Standard FHIR RESTful API.')
        ],

        GlobalConnectorsEnum::REST_SYSTEM_SCOPES_API->value => [
            xl('Enable ClinicaChec FHIR System Scopes (Turn on only if you know what you are doing)'),
            'bool',
            '0',
            xl('Enable ClinicaChec FHIR System Scopes.')
        ],

        GlobalConnectorsEnum::REST_API->value => [
            xl('Enable ClinicaChec Standard REST API'),
            'bool',
            '0',
            xl('Enable ClinicaChec Standard RESTful API.')
        ],

        GlobalConnectorsEnum::REST_PORTAL_API->value => [
            xl('Enable ClinicaChec Patient Portal REST API (EXPERIMENTAL)'),
            'bool',
            '0',
            xl('Enable ClinicaChec Patient Portal RESTful API.')
        ],
...
//                ,2 => xl('All apps Auto Approved') we could add this setting at a latter date
    ...
    'Questionnaires' => [
        ...
        'questionnaire_display_style' => [
            ...
            [
                '0' => xl('ClinicaChec Auto Select Dark/Light Themed Version'),
                '1' => xl('LForms Project Maintained Light Version(Original)'),
                '3' => xl('ClinicaChec Light Theme Version Always'),
                '4' => xl('ClinicaChec Dark Theme Version Always'),
            ],
            '0' ,                          // default = display at top of form
            xl('Choose ClinicaChec auto select based on core theme styles(ClinicaChec dark theme turns on Questionnaire dark, LForms project maintained light styles(Original) or default to always dark or light regardless of core themes.')
        ],
